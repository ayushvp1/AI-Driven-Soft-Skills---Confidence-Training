      ...
      <div className="px-6 py-5 border-b border-slate-700/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">AI Soft Skills Trainer</p>
          </div>
        </div>
      </div>
        ...
        {navItems.map((item) => {
          if ((item as any).isHeader) {
            return (
              <p
                key={item.href}
                className="px-3 pt-6 pb-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest"
              >
                {item.label}
              </p>
            );
